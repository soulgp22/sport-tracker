...
const makeStyles = (c: ThemeColors) => {
  ...
  headerBtn: { width: 40, height: 40, borderRadius: radius.pill, alignItems: 'center', justifyContent: 'center' },
  ...
  progressTrack: { height: 6, borderRadius: radius.pill, backgroundColor: c.border, marginHorizontal: 20 },
  ...
  setBubble: { width: 40, height: 40, borderRadius: radius.pill, backgroundColor: c.surfaceAlt, alignItems: 'center', justifyContent: 'center' },
