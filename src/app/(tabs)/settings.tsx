...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  switchThumb: { width: 22, height: 22, borderRadius: radius.sm, backgroundColor: c.surface },
  ...
  swatch: { width: 20, height: 20, borderRadius: radius.sm, borderWidth: 1, borderColor: c.border },
  codeBlock: {
    backgroundColor: c.surfaceAlt,
    borderRadius: radius.sm,
    padding: spacing.sm,
  ...
  aboutText: { fontSize: 15, fontFamily: fonts.sansSemi, color: c.textPrimary },
