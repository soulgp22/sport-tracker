...
// Les anciennes valeurs `auchan` et `carrefour` restent migr�es � la lecture.
...
function migrateLegacyGym(
  ...
  // Anciennes valeurs du onboarding "salle" ; tout est migr� vers full-gym par d�faut.
...
// Zustand n'expose pas l'hydratation dans l'�tat : ce hook synchronise le routeur
// sans afficher bri�vement l'accueil avant l'onboarding.
