...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  goalCard: { flex: 1, minWidth: 0, padding: 11, borderRadius: radius.lg, backgroundColor: c.surface, shadowColor: c.overlay, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
  goalIcon: { width: 32, height: 32, borderRadius: radius.sm, alignItems: 'center', justifyContent: 'center', marginBottom: 7 },
  ...
  exerciseSelector: { minHeight: 76, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, padding: spacing.md, borderRadius: radius.lg, backgroundColor: c.surface, shadowColor: c.overlay, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
  selectorIcon: { width: 42, height: 42, borderRadius: radius.md, alignItems: 'center', justifyContent: 'center', backgroundColor: c.accentSoft },
  ...
  performanceHero: { padding: spacing.md, borderRadius: radius.pill, backgroundColor: c.primary },
  ...
  confidencePill: { paddingHorizontal: 9, paddingVertical: spacing.xs, borderRadius: radius.pill, backgroundColor: 'rgba(255,255,255,0.16)' },
  confidenceText: { fontSize: 10, fontFamily: fonts.sansBold, color: c.primaryText },
  heroFormula: { marginTop: spacing.xs, fontSize: 12, fontFamily: fonts.sans, color: c.primaryText, opacity: 0.78 },
  setupCard: { flexDirection: 'row', alignItems: 'center', gap: 11, padding: spacing.md, borderRadius: radius.lg, backgroundColor: c.surface, shadowColor: c.overlay, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
  ...
  setupButton: { width: 34, height: 34, borderRadius: radius.lg, alignItems: 'center', justifyContent: 'center', backgroundColor: c.primary },
  rankCard: { padding: spacing.md, borderRadius: radius.lg, backgroundColor: c.surface, shadowColor: c.overlay, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
  rankHeader: { flexDirection: 'row', alignItems: 'center', gap: 11 },
  rankMedal: { width: 46, height: 46, borderRadius: radius.md, alignItems: 'center', justifyContent: 'center' },
  ...
  percentilePill: { paddingHorizontal: 9, paddingVertical: spacing.xs, borderRadius: radius.pill, backgroundColor: c.accentSoft },
  percentileValue: { fontSize: 11, fontFamily: fonts.sansBold, color: c.primary },
  ratioRow: { marginTop: spacing.md, paddingTop: spacing.sm, borderTopWidth: 1, borderTopColor: c.border, flexDirection: 'row', justifyContent: 'space-between' },
  ...
  nextBlock: { marginTop: spacing.sm, gap: 7 },
  ...
  progressTrack: { height: 7, borderRadius: radius.pill, overflow: 'hidden', backgroundColor: c.surfaceAlt },
  progressFill: { height: '100%', borderRadius: radius.pill, backgroundColor: c.primary },
  referenceNote: { marginTop: spacing.sm, fontSize: 9.5, lineHeight: 14, fontFamily: fonts.sans, color: c.textMuted },
  ...
  badgeCard: { width: '31.5%', minHeight: 112, alignItems: 'center', justifyContent: 'center', gap: spacing.xs, padding: spacing.xs, borderRadius: radius.md, borderWidth: 1, borderColor: c.border, backgroundColor: c.surfaceAlt, opacity: 0.65 },
  badgeCardUnlocked: { backgroundColor: c.surface, borderColor: c.primary, opacity: 1 },
  badgeIcon: { width: 38, height: 38, borderRadius: radius.md, alignItems: 'center', justifyContent: 'center', backgroundColor: c.surface },
  ...
  recordsCard: { borderRadius: radius.lg, backgroundColor: c.surface, overflow: 'hidden', shadowColor: c.overlay, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
  recordRow: { minHeight: 62, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.sm, paddingVertical: 9 },
  recordBorder: { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: c.border },
  recordIcon: { width: 34, height: 34, borderRadius: radius.sm, alignItems: 'center', justifyContent: 'center', backgroundColor: c.accentSoft },
