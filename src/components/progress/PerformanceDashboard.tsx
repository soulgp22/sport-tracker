...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  confidencePill: { paddingHorizontal: 9, paddingVertical: spacing.xs, borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.16)' },
  ...
  percentilePill: { paddingHorizontal: 9, paddingVertical: spacing.xs, borderRadius: 999, backgroundColor: c.accentSoft },
